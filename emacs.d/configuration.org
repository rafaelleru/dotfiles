...
** Resaltar linea de edicion
   ...
   #+RESULTS:
   | global-hl-line-mode | load-my-theme | x-wm-set-size-hint | table--make-cell-map |
...
*** autocomplete con company Jedi
   ...
   #+RESULTS:
   | my/python-mode-hook | elpy-mode | er/add-python-mode-expansions |
...
*** autocomplete C/C++ headers from .h files in a project
    ...
    #+RESULTS:
    | irony-mode | my:ac-c-headers-init |
...
**** flycheck rtags integration
	...
	(add-hook 'c-mode-common-hook #'my-flycheck-rtags-setup)
      ...
      #+RESULTS:
      | my-flycheck-rtags-setup | ac-cc-mode-setup |
